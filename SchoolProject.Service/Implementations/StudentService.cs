...
namespace SchoolProject.Service.Implementations
{
    public class StudentService : IStudentService
    {
        ...
        public async Task<string> AddAcync(Student student)
        {
            //Added Student
        ...
        public async Task<string> EditAcync(Student student)
        {
            await _studentRepository.UpdateAsync(student);
            return "Success";
        }

        public async Task<string> DeleteAcync(Student student)
        {
